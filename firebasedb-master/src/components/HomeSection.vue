      ...
      features: [
        {
          ...
          title: "Victory Immortalized",
          text: "NFTs live forever and what you make now, might be extremely valuable 10 years from now",
        },
        {
          img: require("@/assets/img/icon1.png"),
          title: "Connect With Fans",
          text: "Offer new ways for you and your fans to engage with each other",
        },
        {
          img: require("@/assets/img/icon3.png"),
          title: "Easily Create NFTs",
          text: "Just like posting on social media, you can easily mint NFTs within seconds",
        },
      ],
    };
  },
